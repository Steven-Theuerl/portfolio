    ...
    <div className={styles.entireTop}>
        <div className={styles.topContainer}>
            ...
            <div className={styles.topTextContainer}>
                <h1 className={styles.topTextTitle}>
                ...
                <div className={styles.topContactBox}>
                    <h3 className={styles.topContactBox1}>
                        Contact
                    </h3>
                    <div className={styles.topContactBox2}>
                        <p>
                            feel free to <Link to='/Contact' reloadDocument><span className={styles.anchor}> Get in touch with me<svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
