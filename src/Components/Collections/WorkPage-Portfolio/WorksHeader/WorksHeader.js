        ...
        <div className={styles.worksHeaderContainer}>
            <div className={styles.worksHeaderTopContainer}>
                ...
                <p  className={styles.projectDescription}>
                    <span>
                        The website you are looking at right now is my portfolio site. It was designed in large part by my &#40;beautiful and talented&#41; wife and was my first web development project outside of any guided tutorial or course. This page documents some of the things that I learned, used, or felt was important to mention while creating it.
                    </span>
                </p>
            </div>
